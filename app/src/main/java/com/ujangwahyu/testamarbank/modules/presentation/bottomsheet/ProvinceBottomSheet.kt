...
import com.ujangwahyu.testamarbank.modules.presentation.adapter.FormProvinceAdapter
import com.ujangwahyu.testamarbank.modules.presentation.viewmodel.FormViewModel
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class ProvinceBottomSheet: BottomSheetDialogFragment() {
    ...
    private val productAdapter: FormProvinceAdapter by lazy {
        FormProvinceAdapter { item -> selectItem(item) }
    }
    ...
    private fun selectItem(item: ProvinceItem) {
