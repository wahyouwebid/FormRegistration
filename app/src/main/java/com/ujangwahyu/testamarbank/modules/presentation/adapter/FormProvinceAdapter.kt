...
class FormProvinceAdapter(
    private val selectItem: (ProvinceItem) -> Unit
) : RecyclerView.Adapter<FormProvinceAdapter.ViewHolder>() {

    private var data = ArrayList<ProvinceItem>()

    fun setData(categoryList: List<ProvinceItem>) {
        data.clear()
